...
Donate link: 
Tags: iframe, embed, custom fields, youtube, vimeo, google maps, google map, idx
...
You can install Iframe Preserver directly from the WordPress admin panel. Visit the Plugins > Add New page and search for 'Iframe Preserver'. Click to automatically install.  Once installed, activate and it is functional. 
...
A - Yes as many as iframes can be embedded in a page or post as you want.  Just increment the field name from iframe to iframe1, iframe2 ... iframeX
